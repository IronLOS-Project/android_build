...
""" % bcb_dev)
  ...
  script.Print("- IronLOS Project ------------------------------");
  script.Print(" _____                      _      _____  _____ ");
  script.Print("|_   _|                    | |    |  _  |/  ___|");
  script.Print("  | |   _ __   ___   _ __  | |    | | | |\ `--. ");
  script.Print("  | |  | '__| / _ \ | '_ \ | |    | | | | `--. |");
  script.Print(" _| |_ | |   | (_) || | | || |____\ \_/ //\__/ /");
  script.Print(" \___/ |_|    \___/ |_| |_|\_____/ \___/ \____/ ");
  script.Print("- By Ralf979 ------------------ Android 11.0.0 -");
